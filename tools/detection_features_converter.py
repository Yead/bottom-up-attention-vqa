...
train_indices_file = 'coco/train36_imgid2idx.pkl'
val_indices_file = 'coco/val36_imgid2idx.pkl'
train_ids_file = 'coco/train_ids.pkl'
val_ids_file = 'coco/val_ids.pkl'
...
if __name__ == '__main__':
    ...
    if os.path.exists(train_ids_file) and os.path.exists(val_ids_file):
        ...
        train_imgids = utils.load_imageid('coco/train2014')
        val_imgids = utils.load_imageid('coco/val2014')
